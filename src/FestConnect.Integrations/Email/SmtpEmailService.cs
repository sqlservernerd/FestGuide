...
using FestConnect.Infrastructure.Email;
using MailKit.Net.Smtp;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;
using MimeKit;

namespace FestConnect.Integrations.Email;
...
public class SmtpEmailService : IEmailService
{
    ...
    {
        var subject = "Verify your FestConnect account";
        ...
        var htmlBody = BuildEmailTemplate(
            ...
            $@"<p>Hi {encodedDisplayName},</p>
               ...
               <p>If you didn't create a FestConnect account, you can ignore this email.</p>");
    ...
    {
        var subject = "Reset your FestConnect password";
    ...
    {
        var subject = "Your FestConnect password has been changed";
        var encodedDisplayName = HtmlEncoder.Default.Encode(displayName);
        var htmlBody = BuildEmailTemplate(
            "Password Changed",
            $@"<p>Hi {encodedDisplayName},</p>
    ...
    {
        var subject = $"You've been invited to join {festivalName} on FestConnect";

        var registerMessage = isNewUser
            ? "<p>To accept this invitation, you'll need to create a FestConnect account first. Once registered, you'll have access to the festival.</p>"
            : "<p>Log in to your FestConnect account to access the festival.</p>";
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            <p>This email was sent by FestConnect. If you didn't expect this email, you can safely ignore it.</p>
        </div>
    </div>
</body>
</html>";
