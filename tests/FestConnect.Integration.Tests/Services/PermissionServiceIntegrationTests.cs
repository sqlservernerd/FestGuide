...
namespace FestConnect.Integration.Tests.Services;
...
/// </summary>
public class PermissionServiceIntegrationTests : IClassFixture<FestConnectWebApplicationFactory>
{
    private readonly FestConnectWebApplicationFactory _factory;

    public PermissionServiceIntegrationTests(FestConnectWebApplicationFactory factory)
    {
        _factory = factory;
    }
